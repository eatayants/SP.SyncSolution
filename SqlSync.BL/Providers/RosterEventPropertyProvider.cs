...
{
    internal class RosterEventPropertyProvider : ProviderSqlAbstract<RosterEventProperty>
    {
        public RosterEventPropertyProvider()
            : base(string.Empty)
        {
        }
        public RosterEventPropertyProvider(string connectionString)
        ...
        public override RosterEventProperty GetTableDef()
        {
            return new RosterEventProperty();
        }
