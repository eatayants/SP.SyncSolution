...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DbViewNew.aspx.cs" Inherits="Roster.Presentation.Layouts.DbViewNew" DynamicMasterPageFile="~masterurl/default.master" %>
				...
				<td class="ms-authoringControls" valign="top">
                    <table border="0" cellspacing="1" cellpadding="1">
                        ...
                        <tr><td>
                            ...
                            <br />
                            <asp:CheckBox ID="chIsDefault" runat="server" /><label> Make this the default view </label>
                        </td></tr>
			        </table>
	            </td>
	        </tr>
